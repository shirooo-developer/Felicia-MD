...
/*============== STAFF ==============*/
global.owner = [
  ['6281249122429', 'WH MODS DEV', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
...
global.flaaa = pickRandom(ImgLogo())
...
/*============== TEXT ==============*/
global.wait = pickRandom(["```「▰▰▰▱▱▱▱▱▱▱」Loading...```", "_💤 Ada yang eror nih!_"])
global.eror = pickRandom(["```404 error```", "_🕚 Mohon tunggu, dalam proses!_"])
